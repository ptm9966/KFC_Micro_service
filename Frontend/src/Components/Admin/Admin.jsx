...
export const Admin = () => {
    ...
    return <Box p='15px 0' bg='rgb(245,245,245)' minH='90vh'>
        <Flex className={style.topNav} bg='#fff'>
            ...
            <Box className={style.TopNavButton} boxShadow={page === 'orders' ? 'lg' : "none"} onClick={() => { setPage('orders') }} >Orders</Box>
        </Flex>

        {page === 'allProduct' ? <AllProduct /> : page === 'orders' ? <AdminOrders /> : <AddProduct />}
