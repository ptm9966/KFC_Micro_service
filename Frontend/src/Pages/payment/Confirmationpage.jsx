  ...
  return (
    ...
    <div className={styles.divcontent}>
      <div className={styles.divaaa}>
        ...
        <p style={{color:"#e4002b",fontWeight: "900", fontSize:"30px",fontFamily: "Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif"}}> Your order id is : {lastOrder?.orderNo || "Confirmed"}</p>
        ...
        <button style={{  fontSize:"20px",fontFamily: "Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif", backgroundColor:"#e4002b",border:"none",borderRadius:"20px", padding:"10px 20px", marginRight:"12px"}}><Link to="/">Keep Ordering</Link></button>
        <button style={{  fontSize:"20px",fontFamily: "Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif", backgroundColor:"black",border:"none",borderRadius:"20px", padding:"10px 20px"}}><Link to="/signout" style={{color:"white"}}>Order History</Link></button>
        </div>
