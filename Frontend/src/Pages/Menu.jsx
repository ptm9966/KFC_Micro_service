import { Box, Button, Grid, Heading, HStack, Input, SimpleGrid, Text, VStack, Spinner } from "@chakra-ui/react"
...
export const Menu=()=>{
    ...
    const refreshProducts = () => {
        ...
        fetchProductData(`${PRODUCTS_API_BASE_URL}/api/product`, dispatch, "GET_ALLPRODUCT_DATA_SUCCESS");
    ...
    useEffect(()=>{
        ...
        // Refetch products when page becomes visible (user returns to tab)
    ...
    return(
        <Box bg="white" onClick={hideResults} w="100%" >
            ...
            {/* SearchBox and Refresh Button */}

                    <HStack spacing={3} mt="5%">
                        <Box  w={["222px","300px","333px","400px"]} display="block" border="1px solid black" variant="outline" 
